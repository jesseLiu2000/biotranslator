...
train_dataset = EnzymeDataset("/home/tlc/zijie/biotranslator/Demo/data/train_70.json")
validation_dataset = EnzymeDataset("/home/tlc/zijie/biotranslator/Demo/data/new_cut.json")
...
for epoch in range(EPOCH):
    ...
    torch.save(model, f'/home/tlc/zijie/biotranslator/Demo/results/model_ckpt_70/{epoch}_model.pt')
    print("------------------------------------------------------------------")
    print(f"Epoch {epoch}/{EPOCH}, Loss: {total_loss.item():.4f}, Probability: {prob}")
    print("------------------------------------------------------------------")
    

# CUDA_VISIBLE_DEVICES=1 nohup python train.py > log/bio_25.log 2>&1 &